    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.content}>
        <View>
          ...
          <Text style={[globalStyles.titleText,globalStyles.weightBold,globalStyles.titleTextSmall,globalStyles.textAlignLeft,styles.textContainer]}>Число: <Text style={[globalStyles.weightLight]}>{item.delivery_time}</Text></Text>
